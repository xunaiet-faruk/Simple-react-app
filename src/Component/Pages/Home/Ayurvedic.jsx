...
const Ayurvedic = () => {
    return (
        <div className="py-24">
            <div>
                <h1 className="text-[#3A643B] text-center text-[48px] font-semibold">Our ayurvedic approach</h1>
                <hr className="border-2 border-gray-300 w-[550px] mx-auto" />
                <p className="text-center text-[20px] py-7">At Amrutam we follow a unique and personalized approach to healing. Our expert <br/> practitioners begin each treatment process by conducting a thorough analysis of the <br/> patient’s body type, medical history, and current health conditions.</p>
            </div>

            {/* card data here     1      */}
         
            <div className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-1 max-w-screen-xl mx-auto mt-16">
                <div className="max-[350px] h-70 border-t-4 border-[#437844]  space-y-6 rounded-2xl bg-[#FFF7E2] px-6 py-7 shadow-md dark:bg-[#18181B] md:w-[300px]">
